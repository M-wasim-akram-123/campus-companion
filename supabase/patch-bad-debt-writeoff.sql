-- Run in Supabase SQL Editor if write-off on left/dropped/bad_debt is not working yet.
...
-- Backfill existing left / dropped / bad debt students (e.g. ADM-2026-00009).
DO $$
DECLARE
  v_student RECORD;
BEGIN
