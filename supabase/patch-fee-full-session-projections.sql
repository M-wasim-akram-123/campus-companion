-- Run in Supabase SQL Editor to add full-session fee policy projections.
...
DROP POLICY IF EXISTS "Authenticated student fee projections" ON public.student_fee_projections;
